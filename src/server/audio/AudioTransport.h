 ...
 * - Local native playback (fire-and-forget coordinator worker)
 *
...
class AudioTransport {
  public:
     ...
     * For native local audio: submits work to the coordinator
     *
     ...
     * For native local audio: requests cooperative cancellation
     */
    virtual void stop() = 0;
     ...
     *         false if audio runs independently (native local output)
     */

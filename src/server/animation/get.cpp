...
//    }
    ...
    creatures::Animation Database::getAnimation(const std::string& animationId) {
        ...
        try {
            ...
            std::string errorMessage = fmt::format("MongoDB exception while loading an animation: {}", e.what());
            error(errorMessage);

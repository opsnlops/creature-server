...
namespace creatures :: ws {
    ...
    oatpp::Object<creatures::voice::CreatureSpeechResponseDto> VoiceService::generateCreatureSpeech(const oatpp::Object<MakeSoundFileRequestDto> &soundFileRequest) {
        OATPP_COMPONENT(std::shared_ptr<spdlog::logger>, appLogger);
        OATPP_COMPONENT(std::shared_ptr<creatures::voice::CreatureVoices>, creatureVoices);
        ...
        auto speechResponse = creatureVoices->generateCreatureSpeech(std::filesystem::path(config->getSoundFileLocation()),
                                                                     speechRequest);

...
class DataFormatException : public std::exception {
  public:
    ...
    explicit DataFormatException(const char *message) : message_(message) {}
...
class NotFoundException : public std::exception {
  public:
    ...
    // Constructor that takes a C-style string error message
    explicit NotFoundException(const char *message) : message_(message) {}
...
class InternalError : public std::exception {
  public:
    // Constructor that takes an error message string
    explicit InternalError(const std::string &message) : message_(message) {}

    // Constructor that takes a C-style string error message
    explicit InternalError(const char *message) : message_(message) {}
...
class DatabaseError : public std::exception {
  public:
    ...
    // Constructor that takes a C-style string error message
    explicit DatabaseError(const char *message) : message_(message) {}
...
class DuplicateFoundError : public std::exception {
  public:
    ...
    // Constructor that takes a C-style string error message
    explicit DuplicateFoundError(const char *message) : message_(message) {}

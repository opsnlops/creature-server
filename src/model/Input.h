...
class InputDto : public oatpp::DTO {
    ...
    DTO_FIELD_INFO(name) {
        info->description = "The name of the input";
    }
    DTO_FIELD(String, name);

    DTO_FIELD_INFO(slot) {
        info->description = "Which slot this input maps to in the e1.31 packet for this creature";
    }
    ...
    DTO_FIELD_INFO(joystick_axis) {
        info->description = "When recording or streaming, which axis on the joystick should this input be mapped to";
    }

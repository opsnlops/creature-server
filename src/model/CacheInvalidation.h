...
namespace creatures {
    ...
    */
    ...
    /**
     * A signal to clients that they should invalidate a cache they have (if any) for a particular
     * object type.
     *
     * Clients are not required to cache things, but eh Creature Console certainly does. This is
     * a hint from the server that the state on it's side has changed and it should invalidate its
     * own cache and re-pull it.
     *

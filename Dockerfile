...
ADD https://github.com/mongodb/mongo-c-driver/releases/download/1.23.4/mongo-c-driver-1.23.4.tar.gz /build/mongo/c-driver.tar.gz
...
RUN cd /build/mongo/mongo-c-driver-1.23.4/build && \
...
RUN apt update && apt upgrade -y && \
    apt install -y libsasl2-2 libicu72 libprotobuf32 libsdl2-mixer-2.0-0 flac locales-all && \
